...
const ModalUpdateQuiz = (props) => {
    const { show, onClickClose, inforUpdateQuiz, fetchAllQuiz, resetDataUpdate } = props;
    ...
    const handleUpdateQuiz = async () => {
        if (name && description) {
            const resUpdateQUiz = await putUpdateQuiz(inforUpdateQuiz.id, description, name, quizType.value, image)
                    ...
                    <form>
                        <div className="row" id='form'>
                            ...
                            <div className="col-md-12">
                                ...
                                <input type="text" className="form-control" placeholder="Quiz Description"
                                    value={description || ""}
                            ...
                            <div className="form-group col-md-12">
                                ...
                                <Select options={options} placeholder="Quiz Type"
                                    defaultValue={{ label: inforUpdateQuiz.difficulty, value: inforUpdateQuiz.difficulty }}
                                    onChange={setQuizType}
                                />

                            </div>
                            <div className="form-group col-md-12">
                                <label htmlFor="upload-image-quiz" className='btn-upload-image'>Upload File Image</label>
                                <input type="file" className="form-control" hidden id="upload-image-quiz" placeholder="Username"
