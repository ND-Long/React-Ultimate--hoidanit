                        ...
                        listQuiz.map((item, index) => {
                            return (
                                <tr key={`table - user - ${item.id}`}>
                                    ...
                                    <td>
                                        <button className="btn btn-warning mx-1" onClick={() => handleClickUpdateQuiz(item)}>Edit</button>
                                        <button className="btn btn-danger mx-1" onClick={() => handleClickDeleteQuiz(item)} >Delete</button>
                                    </td>
                                </tr>
                            )
                        })
